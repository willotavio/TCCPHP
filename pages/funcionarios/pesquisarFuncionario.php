...
<body>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="../../crud/criarConta/controleConta.php" autocomplete="off" enctype="multipart/form-data">
                                    <div class="form-floating mb-3 mt-3">
                                        <input type="text" class="form-control inputGeral" placeholder="Digite o seu Usuario" required name="nome">
                                        <label class="labelCadastro">Digite o Nome de Usuário</label>
                                    </div>
                                    <div class="form-floating mt-3 mb-3">
                                        <input type="email" class="form-control inputGeral" placeholder="Digite o seu Email" name='email' required>
                                        <label class="labelCadastro">Digite o Email</label>
                                    </div>
                                    <div class="form-floating mt-3 mb-3">
                                        <input type="password" class="form-control inputGeral" placeholder="Digite a sua Senha" name='senha' required>
                                        <label class="labelCadastro">Digite a Senha</label>
                                    </div>
                                    <div class="form-floating mt-3 mb-3">
                                        <input type="password" class="form-control inputGeral" placeholder="Repita a sua Senha" name='confirmarSenha' required>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-outline-success" value="cadastrar" name="botao">Cadastrar</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <form action="pesquisarFuncionario.php" method="get">
        <div class="container justify-content-center barraPesquisa">
            <div class="form-floating  input-group">
                <input class="form-control inputGeral" type="search" name="pesquisarFuncionario" placeholder="Pesquisar">
                ...
                <div class="m-2 ">
                    <table class="table funcionarioTable">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td style='text-align:center'><span id="nome<?php echo $row['id_usuario']; ?>"><?php echo $row['id_usuario']; ?></span>
                                    </td>
                                    <td style='text-align:center'><span id="nome<?php echo $row['nome_usuario']; ?>"><?php echo $row['nome_usuario']; ?></span>
                                    </td>
                                    ...
                                    <td style='text-align:center'><span id="email<?php echo $row['email_usuario']; ?>"><?php echo $row['email_usuario']; ?></span>
                                    </td>
                                    <td style='text-align:center'>
                                        <button class='btn btn-sm btn-outline-primary consultFuncionario' value="<?php echo $row['id_usuario']; ?>">
                                            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-clipboard' viewBox='0 0 16 16'>
                                                <path d='M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z' />
                                                <path d='M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z' />
                                            </svg>
                                        </button>
                                        <button class='btn btn-sm btn-outline-danger deleteFuncionario' value="<?php echo $row['id_usuario']; ?>">
    ...
    <ul class="pagination justify-content-center navPaginacao">
        ...
        if ($pagina < ($totalPagina - 5)) {
            ?>
            <li class="page-item"><a class="page-link" href="?menuop=usuario&pagina=<?php echo $pagina + 1 ?>&pesquisarFuncionario=<?php echo $valor_pesquisarFuncionario; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
    ...
    <div class="modal fade" id="deleteFuncionario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action='../../crud/criarConta/deleteFuncionario.php' method='GET' autocomplete='off'>
                            <div class='form-floating mb-3 mt-3'>
                                <input class='form-control inputGeral' type='number' name='idFuncionario' placeholder='Id' id="idFuncionario" readonly>
    ...
    <div class="modal fade" id="consultarFuncionarioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="container modalHeaderColorCenter">
