        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse navBarLinks" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link selectLinkHeader" href="../responsavelFamilia/responsavelFamilia.php">Famílias</a>
                    </li>
                    <li class="nav-item">
    ...
    <form action="pesquisarResponsavel.php" method="get">
        <div class="container justify-content-center barraPesquisa">
            <div class="form-floating  input-group">
                <input class="form-control inputGeral" type="search" name="pesquisarResponsavel" placeholder="Pesquisar">
