<?php
    if(!empty($_GET['id'])){
        ...
        $sql = "SELECT responsavel_familia.id_responsavel, responsavel_familia.nome_responsavel,responsavel_familia.data_nascimento_responsavel,
                ...
                responsavel_familia.num_responsavel,responsavel_familia.data_atendimento_responsavel,responsavel_familia.cpf_responsavel,
        ...
        <div class="row">
            ...
            <form action='../../../crud/responsavelF/editResponsavelF.php' method='GET' autocomplete="off">
                <div class="form-floating mb-3 mt-3">
                    <input type="text" class="form-control inputCadastro" name='id' required placeholder="ID" readonly
                        value=<?php echo $idResponsavel?>>
                ...
                <div>
                    <select class="form-select inputCadastro" aria-label="Default select example" name="sexoP"
                        class="labelCadastro" value=<?php echo $sexoR?>>
                ...
                <div class="form-floating mb-3 mt-3">
                    <input class="form-control inputCadastro" type="text" id="cep" name="cep" placeholder="CEP" required
                ...
                <div class="form-floating mb-3 mt-3">
                    <input class="form-control inputCadastro" type="text" id="bairro" name="bairro" placeholder="Bairro"
                        readonly>
                    <label class="labelCadastro">Bairro</label>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <input class="form-control inputCadastro" type="text" id="cidade" name="cidade" placeholder="Cidade"
                        readonly>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger"
                        onclick="window.location.href='responsavelFamilia.php';" style="margin-right:20px">
                        Voltar
                    </button>
