    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="container" style="text-align:center"><h4 class="modal-title" id="exampleModalLabel1">Apagar Cesta</h4></div>
                    ...
                    <div class="container-fluid">
                     <form action='../../../crud/cestas/deleteCestas.php' method='GET' autocomplete='off'>
                      <div class='form-floating mb-3 mt-3'>
                            <input class='form-control inputCadastro'  type='number'  name='idCestas1' placeholder='Id'  id="cod" readonly>
                            <label class='labelCadastro'>ID</label>
                        </div>
                     <p>Realmente deseja excluir a Cesta?</p> 
                </div>
