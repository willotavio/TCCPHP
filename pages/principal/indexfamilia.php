                    ...
                    <tbody>
                        ...
                        while ($row = $resultados_familia->fetch()) {
                            ...
                            <div class='modal-dialog' role='document'>
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h5 class='modal-title'>Deletar Informações da Familia</h5>
                                  </button>
                                </div>
                                <div class='modal-body'>
                                  <p>Deseja Realemente Deletar as Informações desta Familia??</p>
                                </div>
                                <div class='modal-footer'>
                                <button type='button' class='btn btn-outline-secondary' data-dismiss='modal'>Cancelar</button>
                                  <a class='btn btn-outline-danger' href='../../crud/familia/deleteFamilia.php?idFamilia=$row[idFamilia]'>Confirmar</a>
                                </div>
                              </div>
                            </div>
                          </div>
                                 ...
                                 <div class='modal fade' id='taticBackdrop' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                                    <div class='modal-dialog'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='staticBackdropLabel'>Alterar Informações da Familia</h5>
                                                <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                            </div>
                                            <div class='modal-body'>
